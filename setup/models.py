...
class tags(models.Model):
    ...
    excerpt_post_id = models.ForeignKey(posts,related_name = 'excerpt_post',db_column = 'excerpt_post_id',on_delete = models.PROTECT,null=True)
    # wiki_post_id=models.IntegerField(("wiki_post_id"),null=True)
    wiki_post_id = models.ForeignKey(posts,related_name = 'wiki_post',db_column = 'wiki_post_id',on_delete = models.PROTECT,null=True)
...
class votes(models.Model):
    ...
    user_id = models.ForeignKey(users,related_name = 'user_id',db_column = 'user_id',on_delete = models.CASCADE,null=True)
    # post_id=models.IntegerField(("post_id"), null=False)
    post_id = models.ForeignKey(posts,related_name = 'post_id_votes',db_column = 'post_id',on_delete = models.CASCADE,null=False)
